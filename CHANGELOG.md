...
### Added
- **AGENT-120** (CWE-78): AI Tool Configuration Hooks Poisoning — detects malicious hooks in .claude/settings.json, .cursor/settings.json, .mcp.json. Ref: CVE-2025-59536 (CVSS 8.7)
